...
Security
Insights
Psycho_11digit_dec/PSYCHO1.py /
@YounisJohn
YounisJohn Update PSYCHO1.py
Latest commit 9b6fb08 on 1 Jun
 History
 1 contributor
492 lines (241 sloc)  7.7 KB
...
print("\033[0;92mThis Tool's Free By kazi samir✌")
...
def menu():
    ...
    print'FB OLD ID CLONING-[KAZI SAMIR✌]'

    print 50* '-'

    print '\033[0;92mCodder   : kazi samir😇'

    print '\033[0;91mAUTHOR   : kazi samir😈'

    print '\033[0;93mFACEBOOK : kazisamir4'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[samir-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[samir-CP]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + '\x1b[0m \n'
