...
print("\033[0;92mThis Tool's Free By kazi samirâœŒ")
...
def menu():
    ...
    print'FB OLD ID CLONING-[KAZI SAMIRâœŒ]'

    print 50* '-'

    print '\033[0;92mCodder   : kazi samirðŸ˜‡'

    print '\033[0;91mAUTHOR   : kazi samirðŸ˜ˆ'
